...
TEST_CASE("H5meta detects nested typedefs") {
    ...
    CHECK(h5::meta::has_size_type<std::vector<int>>::value);

    CHECK(h5::meta::has_value_type<value_only_t>::value);
    CHECK_FALSE(h5::meta::has_size_type<value_only_t>::value);

    CHECK_FALSE(h5::meta::has_value_type<size_only_t>::value);
    CHECK(h5::meta::has_size_type<size_only_t>::value);

    CHECK(h5::meta::has_key_type<std::map<int, double>>::value);
    CHECK(h5::meta::has_mapped_type<std::map<int, double>>::value);

    CHECK(h5::meta::has_key_type<map_like_t>::value);
    CHECK(h5::meta::has_mapped_type<map_like_t>::value);
}
...
TEST_CASE("H5meta iterable aliases behave as expected") {
    ...
    CHECK(h5::meta::is_const_iterable<std::vector<int>>::value);

    CHECK(h5::meta::has_iterator<iterable_t>::value);
    CHECK_FALSE(h5::meta::has_const_iterator<iterable_t>::value);
    CHECK(h5::meta::is_iterable<iterable_t>::value);
    CHECK_FALSE(h5::meta::is_const_iterable<iterable_t>::value);

    CHECK_FALSE(h5::meta::has_iterator<const_iterable_t>::value);
    CHECK(h5::meta::has_const_iterator<const_iterable_t>::value);
    CHECK_FALSE(h5::meta::is_iterable<const_iterable_t>::value);
    CHECK(h5::meta::is_const_iterable<const_iterable_t>::value);
}

TEST_CASE("H5meta map-like detection works") {
    CHECK(h5::meta::is_map_like<std::map<int, double>>::value);
    CHECK(h5::meta::is_map_like<map_like_t>::value);
    CHECK_FALSE(h5::meta::is_map_like<std::vector<int>>::value);
    CHECK_FALSE(h5::meta::is_map_like<value_only_t>::value);
}
